...
private extension WelcomeSlideIndicatorView {
    ...
    func update() {
        indicator1View.backgroundColor = Appearance.progress2Color.withAlphaComponent(index == 1 ? 1 : 0.2)
        indicator2View.backgroundColor = Appearance.progress2Color.withAlphaComponent(index == 2 ? 1 : 0.2)
        indicator3View.backgroundColor = Appearance.progress2Color.withAlphaComponent(index == 3 ? 1 : 0.2)
    }
}
